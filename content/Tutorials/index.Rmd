...
From the table above we can see that the Pseudo-$R^2$ (fixed effects) i.e., the $R^2_m$ is .32, which indicates a large effect size based on @cohen1992powerin for the $R^2$ of multiple linear regression.
...
where $\sigma_f^2$ is calculated as follows:
